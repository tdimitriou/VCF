...
| ContentPresenter | Phase 2a (**P6e-PRES**, **P6e-ALIGN**, **P6e-CC**); **3.1.0** | Paint-only presenter; Button + ContentControl via **`IContentControl`/`ContentHost`**; lookless template tree on Button. |
