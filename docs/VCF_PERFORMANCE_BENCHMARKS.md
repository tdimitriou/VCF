...
**Status:** Phase 4c — **v2.7.0-wpf-alignment-p4c** (21 tests, validated)  
...
|----|----------|--------|---------------|-----------|
| B-GOLD | Golden XAML load (minimal tree) | `Phase0Bench_GoldenXamlLoad` | **20** | ≤ 24 (10% margin) |
