...
**Status:** Baselines recorded — **v2.0.0-wpf-alignment-p0**  
...
| B-COLL | 1000× `ObservableCollection.Add` | `Phase0Bench_CollectionAdd1000` | **16** | ≤ 18 (10% margin) |
