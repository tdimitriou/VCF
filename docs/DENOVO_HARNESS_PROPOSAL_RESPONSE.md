...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**38/38** incl. B-RESZ/B-NAV/B-BIND-DENSE/P2a-PAD*/P7c-DLG) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
