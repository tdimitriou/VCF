...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**46/46** incl. P6i-NEST + P6h-CP + P6g-LIVE + P6f-TBIND + P6e-* + P7c-* + prior 2a gates) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
