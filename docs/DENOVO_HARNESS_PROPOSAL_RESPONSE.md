...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**47/47** incl. P2a-THEME-SWAP + P6i-NEST + P6h-CP + P6g-LIVE + prior 2a gates) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
