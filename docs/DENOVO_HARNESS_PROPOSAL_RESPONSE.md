...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**39/39** incl. P7c-DLG/P7c-PANEL + prior 2a gates) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
