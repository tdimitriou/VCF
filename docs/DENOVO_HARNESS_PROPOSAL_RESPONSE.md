...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**34/34** incl. B-RESZ/B-NAV/B-BIND-DENSE) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
