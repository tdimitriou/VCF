...
| **Phase 2a (VCF parallel)** | Continue framework + harness work; every tag: Phase0 (**40/40** incl. P6e-PRES/P7c-DLG/P7c-PANEL + prior 2a gates) + DeNovoSmoke (stubs only — **no** KernelLib / Data / DB) |
